...
@section('content')
    <div class="container-fluid p-5">
        <div class="row">
            <div class="col-sm-12">
                <h3 class="pb-3 text-primary">Ubah data {{$participant->name}}</h3>
                {{ method_field('post') }}
                {!! Form::model($participant, ['autocomplete'=> 'off','method' => 'POST','route' => ['update-participant'], 'class'=> 'row g-3 submit-form needs-validation','role' => 'form', 'novalidate', 'enctype' => 'multipart/form-data'])  !!}
                {{ csrf_field() }}
